...
1. `git clone https://github.com/infina-concurrency-team7/crypto-price-simulator.git`
...
```bash
# 1. Projeyi temizleyin, derleyin ve paketleyin
mvn clean package

# 2. Üretilen Spring Boot JAR uygulamasını ayağa kaldırın
java -jar target/crypto-price-simulator-0.0.1-SNAPSHOT.jar
```
---
